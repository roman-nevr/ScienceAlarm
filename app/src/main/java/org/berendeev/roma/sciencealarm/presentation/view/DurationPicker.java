...
public class DurationPicker extends TimePickerDialog {
    ...
    public static DurationPicker newInstance(Context context, TimeSetListener callBack, int minutes, int seconds){
        ...
        return new DurationPicker(context, listener, minutes, seconds);
    }

    private DurationPicker(Context context, OnTimeSetListener callBack, int minutes, int seconds) {
