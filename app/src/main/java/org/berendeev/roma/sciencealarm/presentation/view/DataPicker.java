        ...
        try {
            ...
            for (int i = 0; i < dpvalues.size(); i++) {
                try {
                    ...
                    paint.setColor(ContextCompat.getColor(dataPickercontext, R.color.datepickerText));
                    if (selectedvalueId == i) {
                        paint.setColor(ContextCompat.getColor(dataPickercontext, R.color.datepickerSelectedValue));
                        Paint shadowText = new Paint();
                        shadowText.setColor(ContextCompat.getColor(dataPickercontext,  R.color.datepickerSelectedValueShadow));
